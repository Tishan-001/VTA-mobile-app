...
import 'package:vta_mobile/pages/login.dart';
// Import the gesture_detector library
        ...
        body: Container(
          ...
          decoration: const BoxDecoration(
            image: DecorationImage(
              image: AssetImage("assets/2-side.png"),
              fit: BoxFit.cover,
            ),
          ),
          child: Column(
            ...
            children: [
              ...
              const Padding(
                ...
                child: TextField(
                  obscureText: true, // Hide the password text
                  decoration: InputDecoration(
                    labelText: 'Comform your password',
                    border: OutlineInputBorder(),
                    contentPadding:
                        EdgeInsets.symmetric(vertical: 10.0, horizontal: 10.0),
                  ),
              ...
              Padding(
                padding: const EdgeInsets.only(
                    top: 10.0), // Add margin to the top of the button
                child: Container(
